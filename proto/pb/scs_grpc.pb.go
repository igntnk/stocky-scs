...
const (
	UserService_CreateUser_FullMethodName  = "/uas.UserService/CreateUser"
	UserService_BlockUser_FullMethodName   = "/uas.UserService/BlockUser"
	UserService_UnblockUser_FullMethodName = "/uas.UserService/UnblockUser"
	UserService_UpdateUser_FullMethodName  = "/uas.UserService/UpdateUser"
	UserService_GetById_FullMethodName     = "/uas.UserService/GetById"
	UserService_GetAllUsers_FullMethodName = "/uas.UserService/GetAllUsers"
)
...
type UserServiceClient interface {
	...
	BlockUser(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*IdResponse, error)
	UnblockUser(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*IdResponse, error)
	UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...grpc.CallOption) (*IdResponse, error)
	GetById(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*UserModel, error)
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*IdResponse, error) {
...
func (c *userServiceClient) BlockUser(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*IdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IdResponse)
...
func (c *userServiceClient) UnblockUser(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*IdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IdResponse)
...
func (c *userServiceClient) GetById(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*UserModel, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserModel)
...
type UserServiceServer interface {
	...
	BlockUser(context.Context, *IdRequest) (*IdResponse, error)
	UnblockUser(context.Context, *IdRequest) (*IdResponse, error)
	UpdateUser(context.Context, *UpdateUserRequest) (*IdResponse, error)
	GetById(context.Context, *IdRequest) (*UserModel, error)
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *CreateUserRequest) (*IdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUser not implemented")
}
func (UnimplementedUserServiceServer) BlockUser(context.Context, *IdRequest) (*IdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BlockUser not implemented")
}
func (UnimplementedUserServiceServer) UnblockUser(context.Context, *IdRequest) (*IdResponse, error) {
...
func (UnimplementedUserServiceServer) GetById(context.Context, *IdRequest) (*UserModel, error) {
...
func _UserService_BlockUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).BlockUser(ctx, req.(*IdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_UnblockUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UnblockUser(ctx, req.(*IdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
